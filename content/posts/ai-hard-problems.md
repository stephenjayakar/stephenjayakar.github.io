...
1. Find a hard problem. Something like creating a browser (link cursor), adding raytracing to an old game, adding VR to an old game, decompiling an old game (are you starting to see a trend?)
